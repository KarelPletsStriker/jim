...
from jimgw.single_event.SpaceDetector import SpaceBased
...
class HeterodynedTransientLikelihoodFD(TransientLikelihoodFD):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not ref_params:
            print("No ref_params provided, finding reference parameters..")
            ...
            print(f"ref_params provided, which are {self.ref_params}")
